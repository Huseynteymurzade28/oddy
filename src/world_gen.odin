...
/*
Building a run: grow a connected blob of rooms across the grid, stamp a template
into each one, punch doors between neighbours, then decide what lives inside.
Nothing is persisted — dying regenerates the whole map.
*/
